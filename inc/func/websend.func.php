...
class cmsWebSend {
    ...
    public $password = WEBSEND_PASSWORD; /* Password in Websend server config */
    var $host = WEBSEND_HOST;
    var $port = WEBSEND_PORT;
    var $stream;
    ...
    //Connects to a Websend server. Returns true if successful.
     ...
     */
    public function sudoPlayer($cmmd, $playerName) {
	$this->writeRawByte(1);
     ...
     */
    public function sudoConsole($cmmd) {
	$this->writeRawByte(2);
	$this->writeString($cmmd);
